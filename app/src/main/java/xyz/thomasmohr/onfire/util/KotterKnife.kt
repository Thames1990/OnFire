@file:Suppress("UNCHECKED_CAST", "unused", "SimplifiableCallChain")
...
fun <V : View> SupportDialogFragment.bindViews(vararg ids: Int)
        : ReadOnlyProperty<android.support.v4.app.DialogFragment, List<V>> =
...
fun <V : View> SupportDialogFragment.bindViewResettable(id: Int)
        : ReadOnlyProperty<android.support.v4.app.DialogFragment, V> =
...
fun <V : View> SupportFragment.bindViewsResettable(vararg ids: Int)
        : ReadOnlyProperty<android.support.v4.app.Fragment, List<V>> =
    requiredResettable(ids, viewFinder)
